                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="news-one__single">
                            ...
                            <div class="news-one__content">
                                ...
                                <h3 class="news-one__title"><a href="news-details.php?id=<?php echo $dcrow['id'] ?>"><?php echo $dcrow['title'] ?></a></h3>
                                <p class="news-one__text"><?php echo $dcrow['short_description'] ?></p>
                                <div class="news-one__read-more">
                                    <a href="news-details.php?id=<?php echo $dcrow['id'] ?>">Read More <i class="fas fa-angle-double-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
