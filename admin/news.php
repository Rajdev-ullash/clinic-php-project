...
<div class="app-content content container-fluid">
  <div class="content-wrapper">
    ...
    <div class="content-body">
              ...
              <div class="modal-header">
               ...
               <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea rows="6" cols="50" class="form-control square" id="news_short_desp" ></textarea>
                      </div>

                      <div class="form-group">
                      <label  for="menu_head">Article</label>
                      <textarea rows="6" cols="50" class="form-control square" id="news_article" ></textarea>
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <label class="display-inline-block custom-control custom-radio ml-1">
                              <input type="radio" name="show" value="1" class="custom-control-input" id="news_home_page_show">
                              <span class="custom-control-indicator"></span>
                              <span class="custom-control-description ml-0">Yes</span>
                            </label>
                            <label class="display-inline-block custom-control custom-radio">
                              <input type="radio" name="show" value="0" class="custom-control-input" id="news_home_page_show">
                              <span class="custom-control-indicator"></span>
      ...
      include('footer.php');
      ?>
       <script>tinymce.init({selector: '#news_short_desp'});tinymce.init({selector: '#news_article'});</script>
