...
$i=1;
$output1='';
$query = "SELECT * FROM solutions ORDER BY id DESC";
            ...
            <div class="row ">
              ...
              <div class="col-lg-12 col-md-12">
                <table id="example" class="table table-striped table-bordered dt-responsive"  style="width:100%">
                  <thead>
                    <tr>
                      <th width="5%">Solution Id</th>
                      <th width="10%">Solution Caption</th>
                      <th width="6%">Image</th>
          ...
          <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Solution Setup</h4>
              </div>
              
               <div class="modal-body">
                    
                      <div class="form-group">
                      <label  for="menu_head">Solution Caption</label>
                      <input type="text" class="form-control square" id="caption" name="caption" placeholder="Enter Solution Caption">
                      </div>
                    <!--end form group -->
...
function save() {
  ...
  request.open('POST', 'solution_insert.php', true);
