...
$i=1;
$output1='';
$query = "SELECT * FROM package ORDER BY ord DESC";
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="menu_head">Package Title</label>
                                        <input type="text" class="form-control square" id="title" name="title"
                                            placeholder="Enter Project Title">
                                    </div>
                                    <!--end form group -->
                                    <div class="form-group">
                                        <label for="menu_head">Short Description</label>
                                        <input type="text" class="form-control square" id="short_des" name="short_des"
                                            placeholder="Enter short description">
                                    </div>
                                    <div class="form-group">
                                        <label for="menu_head">Details</label>
                                        <textarea rows="6" cols="50" class="form-control square" id="art1"
                                            name="details"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="menu_head">Display order</label>
                                        <input type="text" class="form-control square" id="ord" name="ord"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="menu_head">Validate Date</label>
                                            <input type="date" class="form-control square" id="v_date" name="v_date">
                                        </div>
                                    </div>
...
function addRecord() {
    ...
    function save() {
        ...
        request.open('POST', 'package_insert.php', true);
